"""Script wrapper for the revised Phase 3 DRLearner conversion slice."""
...
from primelift.causal import train_drlearner_conversion_model
...
def _build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Train and score the revised Phase 3 DRLearner conversion model."
    )
    parser.add_argument(
        "--prepared-manifest",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=int,
        default=120,
        help="Number of trees in the DRLearner regression nuisance model.",
    )
    parser.add_argument(
        "--final-estimators",
        type=int,
...
def main() -> None:
    """Train and evaluate the DRLearner conversion model."""
