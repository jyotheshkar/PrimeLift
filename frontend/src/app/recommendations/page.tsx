...
export default function RecommendationsPage() {
  const { header, champion, finalSummary, budgetPlan, suppressedSegments, targetUsers, suppressUsers, notes } =
    recommendationsSnapshot;

  return (
    <main className="relative overflow-hidden">
      <div className="mx-auto flex min-h-screen w-full max-w-[1440px] flex-col px-4 py-5 sm:px-6 lg:px-10">
        <AppHeader current="recommendations" sliceLabel="Phase 7 recommendations dashboard" />
          ...
          <SectionCard eyebrow="Final stance" title="Current operating instruction">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="rounded-full border border-teal-700/15 bg-teal-500/10 px-4 py-3 text-xs font-semibold uppercase tracking-[0.24em] text-teal-900">
